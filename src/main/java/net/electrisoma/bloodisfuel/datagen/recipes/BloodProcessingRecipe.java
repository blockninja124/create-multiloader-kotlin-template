...
public abstract class BloodProcessingRecipe extends CreateRecipeProvider {
    protected static final List<BloodProcessingRecipe> GENERATORS = new ArrayList<>();

    public static void registerAll(DataGenerator gen, PackOutput output) {
        GENERATORS.add(new MixingRecipes(output));
        GENERATORS.add(new EmptyingRecipes(output));
        ...
        gen.addProvider(true, new DataProvider() {
            ...
            public String getName() {
                return BloodIsFuel.MOD_ID + " Processing Recipes";
            }
    ...
    public BloodProcessingRecipe(PackOutput output) {
        super(output);
    }
    protected <T extends ProcessingRecipe<?>>
    GeneratedRecipe create(String namespace,
