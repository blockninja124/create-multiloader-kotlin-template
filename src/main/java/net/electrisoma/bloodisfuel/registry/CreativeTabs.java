...
public class CreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> BASE_CREATIVE_TAB = REGISTER.register("base",
            () -> CreativeModeTab.builder()
                    ...
                    .icon(() -> BIF_Fluids.VISCERA.getBucket().get().getDefaultInstance())
                    .displayItems(new CreativeTabs.RegistrateDisplayItemsGenerator(true, CreativeTabs.BASE_CREATIVE_TAB))
                    .build());
    ...
    private record RegistrateDisplayItemsGenerator(
            boolean addItems, RegistryObject<CreativeModeTab> tabFilter)
